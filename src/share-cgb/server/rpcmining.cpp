...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "CryptogenicBullion is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "CryptogenicBullion is downloading blocks...");
...
int cb_submitblock(char *hashPrevBlock, char *hashMerkleRoot, unsigned int nTime, unsigned int nBits, unsigned int nNonce)
{
...
const char *json_getblocktemplate(void)
{
