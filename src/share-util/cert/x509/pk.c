 ...
 */
int pk_init_ctx_shrsa_alt( pk_context *ctx, void * key,
                         pk_rsa_alt_decrypt_func decrypt_func,
                         pk_rsa_alt_sign_func sign_func,
                         pk_rsa_alt_key_len_func key_len_func )
{
    shrsa_alt_context *shrsa_alt;
    const pk_info_t *info = &shrsa_alt_info;
    ...
    shrsa_alt = (shrsa_alt_context *) ctx->pk_ctx;

    shrsa_alt->key = key;
    shrsa_alt->decrypt_func = decrypt_func;
    shrsa_alt->sign_func = sign_func;
    shrsa_alt->key_len_func = key_len_func;
                   ...
                   const unsigned char *sig, size_t sig_len )
{
    ...
    if( type == POLARSSL_PK_RSASSA_PSS )
    {
        ...
        ret = shrsa_shrsassa_pss_verify_ext( pk_rsa( *ctx ),
