...
ZEND_NAMED_FUNCTION(_wrap_shjson_num) {
  ...
  /*@SWIG:/usr/share/swig/2.0.9/php/utils.i,52,CONVERT_FLOAT_IN@*/
...
static zend_function_entry share_php_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(shpref_path,_wrap_shpref_path,NULL)
 SWIG_ZEND_NAMED_FE(shpref_init,_wrap_shpref_init,NULL)
