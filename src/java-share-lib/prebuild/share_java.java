...
public class share_java {
  ...
  public static SWIGTYPE_p_uint64_t shcrc(SWIGTYPE_p_void data_p, int len) {
    return new SWIGTYPE_p_uint64_t(share_javaJNI.shcrc(SWIGTYPE_p_void.getCPtr(data_p), len), true);
  }
  ...
  public static SWIGTYPE_p_shtime_t shtime64() {
    return new SWIGTYPE_p_shtime_t(share_javaJNI.shtime64(), true);
  }

  public static String shctime64(SWIGTYPE_p_shtime_t t) {
    return share_javaJNI.shctime64(SWIGTYPE_p_shtime_t.getCPtr(t));
  }

  public static SWIGTYPE_p_time_t shutime64(SWIGTYPE_p_shtime_t t) {
    return new SWIGTYPE_p_time_t(share_javaJNI.shutime64(SWIGTYPE_p_shtime_t.getCPtr(t)), true);
  }
  ...
  public static SWIGTYPE_p_uint64_t shfs_crc(SWIGTYPE_p_shfs_ino_t file) {
    return new SWIGTYPE_p_uint64_t(share_javaJNI.shfs_crc(SWIGTYPE_p_shfs_ino_t.getCPtr(file)), true);
  }
  ...
  public static int shfs_write_mem(String path, SWIGTYPE_p_void data, long data_len) {
    return share_javaJNI.shfs_write_mem(path, SWIGTYPE_p_void.getCPtr(data), data_len);
  }
  ...
  public static void shbuf_cat(SWIGTYPE_p_shbuf_t buf, SWIGTYPE_p_void data, long data_len) {
    share_javaJNI.shbuf_cat(SWIGTYPE_p_shbuf_t.getCPtr(buf), SWIGTYPE_p_void.getCPtr(data), data_len);
  }
  ...
  public static void shbuf_free(SWIGTYPE_p_p_shbuf_t buf_p) {
    share_javaJNI.shbuf_free(SWIGTYPE_p_p_shbuf_t.getCPtr(buf_p));
  }

  public static int shbuf_grow(SWIGTYPE_p_shbuf_t buf, long data_len) {
    return share_javaJNI.shbuf_grow(SWIGTYPE_p_shbuf_t.getCPtr(buf), data_len);
  }

  public static SWIGTYPE_p_shbuf_t shbuf_file(String path) {
    long cPtr = share_javaJNI.shbuf_file(path);
    return (cPtr == 0) ? null : new SWIGTYPE_p_shbuf_t(cPtr, false);
  }

  public static int shbuf_growmap(SWIGTYPE_p_shbuf_t buf, long data_len) {
    return share_javaJNI.shbuf_growmap(SWIGTYPE_p_shbuf_t.getCPtr(buf), data_len);
  }

  public static SWIGTYPE_p_shbuf_t shbuf_map(SWIGTYPE_p_unsigned_char data, long data_len) {
    long cPtr = share_javaJNI.shbuf_map(SWIGTYPE_p_unsigned_char.getCPtr(data), data_len);
    return (cPtr == 0) ? null : new SWIGTYPE_p_shbuf_t(cPtr, false);
  }
  ...
  public static SWIGTYPE_p_shkey_t shkey_cert(SWIGTYPE_p_shkey_t key, SWIGTYPE_p_uint64_t crc, SWIGTYPE_p_shtime_t stamp) {
    long cPtr = share_javaJNI.shkey_cert(SWIGTYPE_p_shkey_t.getCPtr(key), SWIGTYPE_p_uint64_t.getCPtr(crc), SWIGTYPE_p_shtime_t.getCPtr(stamp));
    return (cPtr == 0) ? null : new SWIGTYPE_p_shkey_t(cPtr, false);
  }

  public static int shkey_verify(SWIGTYPE_p_shkey_t sig, SWIGTYPE_p_uint64_t crc, SWIGTYPE_p_shkey_t key, SWIGTYPE_p_shtime_t stamp) {
    return share_javaJNI.shkey_verify(SWIGTYPE_p_shkey_t.getCPtr(sig), SWIGTYPE_p_uint64_t.getCPtr(crc), SWIGTYPE_p_shkey_t.getCPtr(key), SWIGTYPE_p_shtime_t.getCPtr(stamp));
  }
  ...
  public static void shmeta_set_void(SWIGTYPE_p_shmeta_t ht, SWIGTYPE_p_shkey_t key, SWIGTYPE_p_void data, long data_len) {
    share_javaJNI.shmeta_set_void(SWIGTYPE_p_shmeta_t.getCPtr(ht), SWIGTYPE_p_shkey_t.getCPtr(key), SWIGTYPE_p_void.getCPtr(data), data_len);
  }
  ...
  public static int shbuf_sprintf(SWIGTYPE_p_shbuf_t buff, String fmt) {
    return share_javaJNI.shbuf_sprintf(SWIGTYPE_p_shbuf_t.getCPtr(buff), fmt);
  }
  ...
  public static int shencode(String data, long data_len, SWIGTYPE_p_p_uint8_t data_p, SWIGTYPE_p_uint32_t data_len_p, SWIGTYPE_p_shkey_t key) {
    return share_javaJNI.shencode(data, data_len, SWIGTYPE_p_p_uint8_t.getCPtr(data_p), SWIGTYPE_p_uint32_t.getCPtr(data_len_p), SWIGTYPE_p_shkey_t.getCPtr(key));
  }
  ...
  public static int ashdecode(SWIGTYPE_p_uint8_t data, SWIGTYPE_p_size_t data_len_p, SWIGTYPE_p_shkey_t key) {
    return share_javaJNI.ashdecode(SWIGTYPE_p_uint8_t.getCPtr(data), SWIGTYPE_p_size_t.getCPtr(data_len_p), SWIGTYPE_p_shkey_t.getCPtr(key));
  }
  ...
  public static int shdecode(SWIGTYPE_p_uint8_t data, SWIGTYPE_p_uint32_t data_len, SWIGTYPE_p_p_char data_p, SWIGTYPE_p_size_t data_len_p, SWIGTYPE_p_shkey_t key) {
    return share_javaJNI.shdecode(SWIGTYPE_p_uint8_t.getCPtr(data), SWIGTYPE_p_uint32_t.getCPtr(data_len), SWIGTYPE_p_p_char.getCPtr(data_p), SWIGTYPE_p_size_t.getCPtr(data_len_p), SWIGTYPE_p_shkey_t.getCPtr(key));
  }
  ...
  public static String shdigest(SWIGTYPE_p_void data, SWIGTYPE_p_int32_t len) {
    return share_javaJNI.shdigest(SWIGTYPE_p_void.getCPtr(data), SWIGTYPE_p_int32_t.getCPtr(len));
  }
