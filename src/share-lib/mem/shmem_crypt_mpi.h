...
#ifndef __MEM__SHMEM_CRYPT_MPI_H__
#define __MEM__SHMEM_CRYPT_MPI_H__
...
#define MPI_ERR_MPI_FILE_IO_ERROR                     -0x0002  /**< An error occurred while reading from or writing to a file. */
#define MPI_ERR_MPI_BAD_INPUT_DATA                    -0x0004  /**< Bad input parameters to function. */
#define MPI_ERR_MPI_INVALID_CHARACTER                 -0x0006  /**< There is an invalid character in the digit string. */
#define MPI_ERR_MPI_BUFFER_TOO_SMALL                  -0x0008  /**< The buffer is too small to write to. */
#define MPI_ERR_MPI_NEGATIVE_VALUE                    -0x000A  /**< The input arguments are negative or result in illegal output. */
#define MPI_ERR_MPI_DIVISION_BY_ZERO                  -0x000C  /**< The input argument for division is zero, which is not allowed. */
#define MPI_ERR_MPI_NOT_ACCEPTABLE                    -0x000E  /**< The input arguments are not acceptable. */
#define MPI_ERR_MPI_MALLOC_FAILED                     -0x0010  /**< Memory allocation failed. */
...
#endif /* ndef __MEM__SHMEM_CRYPT_MPI_H__ */
